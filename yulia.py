...
def ighuntu():
    ...
    banner()
    input(p+"\n ["+h+"•"+p+"] Open Instagram? ")
    cangcut(p+" ["+h+"•"+p+"] Open Instagram...")
    os.system("xdg-open https://www.instagram.com/Galihjohan79")
    input(p+" [Back]")
    asup_goblog()   
...
def ngasupkeun():
    ...
    banner()
    input(p+"\n ["+h+"•"+p+"] Open Youtube? ")
    cangcut(p+" ["+h+"•"+p+"] Open Youtube...")
    os.system("xdg-open https://youtube.com/NDR74KRNFzk?feature=share")
    input(p+" [Back]")
    asup_goblog()   

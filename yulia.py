...
def bantuan():
	print((p+"\n ["+h+"•"+p+"] Silahkan tonton video tutorialnya"))
	cangcut((p+" ["+h+"•"+p+"] Cari videonya di channel youtube suami gue :v"))
	selempak((p+" ["+h+"•"+p+"] Sabar coek bentar lagi di arahin ke youtube nih :v"))
	os.system('xdg-open https://youtube.com/channel/UCSJDs-6vbcEv_twPYbUAdaA')
	asup_goblog() 
...
def ewesoang(file):
  ...
  print((p+" ["+h+"01"+p+"] [FAST] Api.Facebook"))
  print((p+" ["+h+"02"+p+"] [FAST] Api.Facebook + TTL "))
  print((p+" ["+h+"03"+p+"] [SLOW] Mbasic.Facebook"))
  print((p+" ["+h+"04"+p+"] [SLOW] Mbasic.Facebook + TTL"))
  print((p+" ["+h+"05"+p+"] [SLOW] Touch.Facebook"))
  print((p+" ["+h+"06"+p+"] [SLOW] Touch.Facebook + TTL "))
  print((p+" ["+h+"07"+p+"] [SUPER SLOW] M.Facebook "))
  print((p+" ["+h+"08"+p+"] [SUPER SLOW] M.Facebook + TTL "))
  print((p+" ["+h+"09"+p+"] [SUPER SLOW ] Free.Facebook "))
  print((p+" ["+h+"10"+p+"] [SUPER SLOW] Free.Facebook + TTL "))
  print((p+" ["+h+"00"+p+"] Back "))
  print((p+"\n ["+h+"!"+p+"] If No Result, Use Airplane Mode (10 Sec)"))
